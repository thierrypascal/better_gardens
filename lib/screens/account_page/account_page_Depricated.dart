...
class AccountPage_Depricated extends StatefulWidget {
  /// Displays the page with account information
  AccountPage_Depricated({Key key, ServiceProvider serviceProvider})
  ...
  @override
  _AccountPage_DepricatedState createState() => _AccountPage_DepricatedState();
}

class _AccountPage_DepricatedState extends State<AccountPage_Depricated> {
  @override
                    ...
                    if (_formKey.currentState.validate()) {
                      ...
                      if (_firstPassword == _secondPassword) {
                        ...
                        if (_responseAnswer == null) {
                          ...
                          print(
                              'Grund für den Fehlschlag: $_responseAnswer');
                        }
                      }
                    }
                  },
